...
# blake is an alternative to the HMAC
blake = hashlib.blake2b(key=key, digest_size=32)  # can output digest of fixed size (truncating real output)
blake.update(msg)
...
# hmac.compare_digest provides constant time comparison of digest -> very used in practice
