...
# loop
m = ciphertext
for i in range(n.bit_length()): # Iterate over all bits of the modulus
    m = (pow(2, e, n) * m) % n
...
print(to_bytes(lower_bound,n.bit_length()))
print(to_bytes(upper_bound,n.bit_length()))

#print decoded message
# "this is the message to encrypT" -> due to not precise enough integers in python
