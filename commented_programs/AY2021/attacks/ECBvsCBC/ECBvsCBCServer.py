...
from AY2021.mysecrets import ecb_oracle_key, HOST, PORT
...
while 1:
    ...
    # receive the chosen plaintext from the user and add prefix and suffix not controllable by the attacker
