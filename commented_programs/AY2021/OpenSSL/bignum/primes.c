...
int main(){
  ...
  */
  ...
  // BN_generate_prime_ex is deprecated in OpenSSL 3.0 use the one below instead (also has a context for more generic
  // generation: customize tests for prime properties)
  ...
  */
  ...
  printf("Num bits of prime2 is %d\n",BN_num_bits(prime2));
